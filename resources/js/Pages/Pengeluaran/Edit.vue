...
export default {
    ...
    setup(props) {
        const form = useForm({
            ...
            nominal_transaksi: props.pengeluaran.nominal_transaksi,
            tanggal_transaksi: props.pengeluaran.tanggal_transaksi,
            deskripsi: props.pengeluaran.deskripsi,
    ...
    methods: {
        submit() {
            this.form.put(route("pengeluarans.update", this.pengeluaran.id));
        },
    },
    props: {
        user: Object,
